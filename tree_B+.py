class Node(object):
    ...
    def __init__(self, order):
        ...
        simplesmente atuam como um meio para atravessar a árvore."""
        self.order = order
        self.keys = []
        self.values = []
        self.leaf = True
...
# Se o nó estiver vazio, basta inserir o par de valores-chave.
        ...
        for i, item in enumerate(self.keys):
           ...
           # Se a nova chave for maior do que todas as chaves existentes, insira a nova chave à direita de todas as chaves existentes.
            elif i + 1 == len(self.keys):
                self.keys.append(key)
                self.values.append([value])

    def split(self):
        "" "Divide o nó em dois e os armazena como nós filho." ""
...
class BPlusTree(object):
    ...
    def _find(self, node, key):
       "" "Para um determinado nó e chave, retorna o índice onde a chave deve ser inserida e a lista de valores nesse índice." ""
    ...
    def _merge(self, parent, child, index):
      "" "Para um nó pai e filho, extraia um pivô do filho para ser inserido nas chaves do pai. Insira os valores do filho nos valores do pai.
         "" "
    ...
    def insert(self, key, value):
       "" "Insere um par de valores-chave após passar para um nó folha. Se o nó folha estiver cheio, divida o nó folha em dois.
         "" "
        parent = None
        child = self.root
       ...
       # Percorra a árvore até que o nó folha seja alcançado.
        ...
        if child.is_full():
           ...
           # Uma vez que um nó folha é dividido, ele consiste em um nó interno e dois nós folha. Estes
           # precisam ser reinserido na árvore.
            if parent and not parent.is_full():
                self._merge(parent, child, index)

    def retrieve(self, key):
      "" "Retorna um valor para uma determinada chave e Nenhum se a chave não existir." ""
        child = self.root
